...
const ServiceCard = ({ 
  ...
  return (
    <div 
      className={`opacity-100 transition-opacity duration-500 ease-in-out rounded-xl p-8 border border-border bg-white shadow-sm hover:shadow-md transition-all duration-300`}
    >
...
const Services = () => {
  return (
    <div 
      id="services" 
      className="bg-secondary/30 py-24 opacity-100"
    >
